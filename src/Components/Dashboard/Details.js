...
const Details = () => {
  ...
  const fetchData = async () => {
    try {
      ...
      const response = await axios.get(
        `${url}memberdetailroute/fetch-member`,
        {
          headers: {
  ...
  const splitExpense = async (formData, selectedNumber) => {
    ...
    try {
      const response = await axios.post(
        `${url}memberdetailroute/member-average`,
        {
  ...
  const fetchPayData = async () => {
    try {
      const response = await axios.post(`${url}memberdetailroute/pay-data`, {
        groupName: groupname,
      });
