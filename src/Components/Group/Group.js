...
const Group = () => {
  ...
  const fetchGroupData = async () => {
    ...
    try {
      const response = await axios.get(
        `${url}group/group-name` // Use the imported URL
      );
  ...
  const handleDelete = async (groupName) => {
    try {
      await axios.delete(
        `${url}group/delete-group/${groupName}` // Use the imported URL
      );
  ...
  const handlegroupdetails = async (groupName) => {
    try {
      const response = await axios.get(`${url}memberdetailroute/members/${groupName}`);
  ...
  const fetchMemberDataFromToken = async () => {
    ...
    try {
      const response = await axios.get(`${url}group/fetch/${group_name}`, { 
        headers: {
